...
const Header: FunctionComponent<HeaderProps> = ({
  ...
  return (
    <div
      ref={rewind}
      className="relative flex flex-row w-full w-full gap-10 md:gap-1 md:justify-between md:content-between pt-6 md:pt-10 min-h-96 md:h-80 justify-center md:min-h-80 md:pl-8 md:pr-8 pb-4 overflow-x-hidden text-mainText"
    >
      <div className="relative w-fit min-h-full h-full">
        <div className="relative flex flex-col md:w-fit h-full min-h-full font-fira text-xs md:place-self-start place-self-center text-center md:text-left md:pr-20 lg:pr-11">
      ...
      <div className="relative col-start-1 md:col-start-3 row-start-3 md:row-start-1 w-full md:w-fit min-w-full min-h-full h-full">
        <div className="flex flex-col relative w-full h-full gap-4">
          ...
          <div className="relative w-full h-fit row-start-3 place-self-start pr-5">
            <div className="relative w-fit h-fit flex flex-row gap-2 pt-4">
              <div
