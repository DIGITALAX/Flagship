...
const Grid: FunctionComponent<GridProps> = ({
  ...
  return (
    <div className="bg-offBlack w-full h-fit relative grid md:grid-flow-row md:auto-rows-auto grid-flow-col auto-cols-auto pb-4 pt-4">
      ...
      ></div>
      <div className="row-start-3 md:row-start-1 col-start-1 md:col-start-3 relative w-full h-[60vw] md:h-full border-offBlack md:border-8 md:border-l-4 md:border-b-4">
        <Image
          objectFit="cover"
          layout="fill"
      ...
      <div className="row-start-4 md:row-start-2 col-start-1 relative w-full wide:w-[20vw] min-w-fit pb-12 lg:pb-0 h-full border-offBlack border-8 border-r-0 border-b-0 text-darkG bg-grayL font-aud text-[4vw] sm:text-[2.5vw] lg:text-[3.2vw] xl:text-[2.8vw] leading-tight px-6 pt-6 break-word">
      ...
      <div className="row-start-5 md:row-start-2 col-start-1 md:col-start-2 relative w-full h-full border-offBlack border-t-4 border-x-4 border-b-0 min-h-fit grid-flow-row grid auto-rows-auto">
        ...
        ></div>
        <div className="relative md:absolute row-start-2 w-full min-h-fit h-fit p-2 border-t-8 border-offBlack self-end place-self-end m-0 bg-midWhite border-4 border-b-0">
      ...
      <div className="row-start-6 md:row-start-2 col-start-1 md:col-start-3 relative w-full h-fit lg:h-full bg-offWhite border-offBlack border-t-8 galaxy:border-r-8 galaxy:border-l-4 border-b-0">
